...
@Component({
    ...
    templateUrl: './bannershop.component.html',
    styleUrls: [
        './bannershop.component.scss'
    ]
})
export class AdminBannerShopComponent implements OnInit {
    ...
    getBanners() {
        this.selected = [];
        this.api.all('bannershop').customGET('',{page: this.pageIndex,pageSize: this.pageSize,type: this.filter.type}).subscribe(res => {

...
export class AdminTipDetailsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.form = new FormGroup({
            ...
            cover_img1: new FormControl(this.tip.cover_img1, [Validators.required]),
            cover_img2: new FormControl(this.tip.cover_img2, [Validators.required]),
            cover_img3: new FormControl(this.tip.cover_img3, [Validators.required]),
            cover_img4: new FormControl(this.tip.cover_img4, [Validators.required]),
            tips_desc_head: new FormControl(this.tip.tips_desc_head, [Validators.required]),
            tips_desc_body: new FormControl(this.tip.tips_desc_body, [Validators.required]),
            cont1_type: new FormControl(this.tip.cont1_type, [Validators.required]),
            cont2_type: new FormControl(this.tip.cont2_type, [Validators.required]),
            caption_text: new FormControl(this.tip.caption_text, [Validators.required]),
            source_site_name: new FormControl(this.tip.source_site_name, [Validators.required]),
            source_site_url: new FormControl(this.tip.source_site_url, [Validators.required]),
            cont1_head: new FormControl(this.tip.cont1_head, [Validators.required]),
            ...
            cont2_head: new FormControl(this.tip.cont2_head, [Validators.required]),
            caption_text2: new FormControl(this.tip.caption_text2, [Validators.required]),
            source_site_name2: new FormControl(this.tip.source_site_name2, [Validators.required]),
            source_site_url2: new FormControl(this.tip.source_site_url2, [Validators.required]),
            ...
            cont1_photo: new FormControl(this.tip.cont1_photo, [Validators.required]),
            cont2_photo: new FormControl(this.tip.cont2_photo, [Validators.required]),

...
export class AdminPointDetailsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.form = new FormGroup({
            ...
            start_date: new FormControl(this.point.start_date, [Validators.required]),
            end_date: new FormControl(this.point.end_date, [Validators.required]),
            add_point: new FormControl(this.point.add_point, [Validators.required]),

...
@Component({
    selector: 'app-admin-campaign-information-add',
    templateUrl: './information-add.component.html',
    styleUrls: [
        './information-add.component.scss'
    ]
})
export class AdminCampaignInformationAddComponent implements OnInit {
    ...
    getItemChannel() {
        this.campaginService.getData(`api/admin/sns`).subscribe(
            res => {
                ...
                console.log(this.dataBlind.channels,'channel');
            });
    }
    ...
    addData() {
        if (this.formvalue.valid) {
            ...
            let body = {
                ...
                m_ch_url: this.formvalue.value.m_ch_url,
                sns_id: this.formvalue.value.sns_id,
                m_ch_crawl_date:'2019-03-03',
                m_ch_view:'0',
                m_ch_comment:'0',
                m_ch_share: '0',
                m_ch_like:'0',
                m_ch_active_url:1,
                cp_id:this.idCampaign

            };

            console.log(body, 'body');
            this.campaginService.adminAddReview(body).subscribe((res:any) => {
                this.toa.success('add review success');
            });
        }
    }
